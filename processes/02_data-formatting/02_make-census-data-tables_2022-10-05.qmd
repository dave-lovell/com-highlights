...
save_location_tables <- function(locations, this_path){
  ...
  walk2(.x = locations,
        ...
        .f = save_each_table, # defined below
...
save_each_table <- 
  function(location_tables, location_name, directory){
    ...
    save_path     <- dir_create(this_path, location_name)
    location_name <- as.list   (names(location_tables)  )
...
save_table <-
  function(stat_table, stat_name,
    ...
    write_csv(stat, save_path)
  }
#:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::


## EXECUTE ###################################################################
walk2(census_tables, paths, )                                               #|
##############################################################################
```
