...
lil_test <- select(penguins, species, island, sex, year, ends_with("_mm"))
head(lil_penguins)
...
## muck around w/ penguins
require(palmerpenguins)

head(penguins)

lil_penguins <- select(penguins, species, island, sex, year, ends_with("_mm"))
head(lil_penguins)
