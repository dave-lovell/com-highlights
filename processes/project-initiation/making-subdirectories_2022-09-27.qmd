...
create_com_dirs <- function(com_name){
  ...
  com_sub_folders <- here("intermediate-com-outputs", com_name, sub_folders)
  
  print(com_sub_folders[1])
 
}
create_com_dirs(com_name = com_names_list)
dir.create(create_com_dirs(com_sub_folders))
